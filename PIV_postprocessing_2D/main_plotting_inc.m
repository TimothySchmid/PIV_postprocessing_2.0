...
% ======================================================================= %
  ...
  INPUT.xcorrection         = -58;
  INPUT.ycorrection         =  101;
...
for iRead = (1:1:n) % start_position : increment : end_position
...
% set(gca,'color','black') 
% plot(valid_x(ch),valid_y(ch),'-w','LineWidth',3)
set(gca,'color','white') 
